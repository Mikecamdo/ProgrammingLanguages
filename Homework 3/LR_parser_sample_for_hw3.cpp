...
{  
    ...
    {  
        // checking stack for producing rule F->i  
    ...
    for (stack_position = 0; stack_position < input_len; stack_position++) {
        if (stk[stack_position] == 'T' && stk[stack_position + 1] == '*' && stk[stack_position + 2] == 'F') {
    ...
    for (stack_position = 0; stack_position < input_len; stack_position++) {
        if (stk[stack_position] == 'T' && stk[stack_position + 1] == '+' && stk[stack_position + 2] == 'T') {
