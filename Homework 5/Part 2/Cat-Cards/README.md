...
Make sure to fix the missing info in 'RestCatFactService/RestCatPicService`.
...
5. As you fix the missing code of this exercise, return to the browser and refresh the page. The features of this page begin working.
