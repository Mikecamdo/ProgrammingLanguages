...
class Lexer:
    ...
    def start_process(self, text):
        ...
        token = self.start() #start the expression call
        self.assert_end()
    ...
    def match(self, *syntax_rules):
        ...
        for name in syntax_rules:
            ...
            #print("syntax rules:",syntax_rules)
            #print("name:",name)
...
class CalcParser(Lexer):
    ...
    def factor(self):
        # This section for the following rule:
        #   <factor> 	-> 	(<expr>)
        #    
        op = self.maybe_char('(')
        if op == '(':
...
if __name__ == '__main__':
    ...
    print("The answer is: ", parser.start_process(input()))
