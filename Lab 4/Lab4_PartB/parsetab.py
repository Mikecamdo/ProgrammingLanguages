...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','ply_example1.py',44),
  ('expr -> expr MINUS expr','expr',3,'p_sub','ply_example1.py',48),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','ply_example1.py',52),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','ply_example1.py',56),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','ply_example1.py',57),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','ply_example1.py',68),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','ply_example1.py',72),
]
